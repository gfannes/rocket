...
namespace rocket { 
    ...
    {
        public:
            Motor(double length, double in_diameter): length_(length), in_diameter_(in_diameter)
        {
            ...
            double thrust() const
            {
                ...
                const double propellant_burning_surface_area_per_motor = buring_sides * length_ * propellant_grain_square_side_length_();
                //Propellant consumption a.k.a. propellant burn rate a.k.a m_dot	892.3394983	kg/s
                const double motor_propellant_burn_rate = propellant_burning_surface_area_per_motor * galcit::burn_rate_at_135_bar * galcit::density;
            ...
            double cost() const
            {
                ...
                const double propellant_grain_volume = tmp*tmp * length_;
                const double propellant_grain_mass = propellant_grain_volume * galcit::density;
